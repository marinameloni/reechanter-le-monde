...
<style scoped>
/* Reuse same styles as Auth.vue (player card layout) */
.index-landing { min-height: 100vh; background-color: #0072bc; display: flex; justify-content: center; align-items: center; font-family: 'Arial Rounded MT Bold', 'Helvetica', sans-serif; }
.game-container { width: 900px; height: 550px; position: relative; border: 6px solid #005a96; border-radius: 20px; background: #39f; display: flex; flex-direction: column; }
...
.card-inner { background: #005a96; height: 100%; border-radius: 14px; display: flex; flex-direction: column; align-items: center; justify-content: space-around; overflow: hidden; position: relative; }
...
.cp-input { width: 100%; padding: 10px; border: 2px solid #005a96; border-radius: 4px; margin-bottom: 15px; font-size: 1.1rem; }
.checkbox-group { font-size: 0.9rem; margin-bottom: 20px; }
.btn-cp-login { background: linear-gradient(#1e90ff, #0072bc); border: 3px solid #00bfff; border-radius: 50px; color: white; padding: 10px 40px; font-size: 1.4rem; font-weight: bold; cursor: pointer; box-shadow: 0 4px 0 #005a96; }
...
.sticky-note { position: absolute; bottom: -60px; right: -20px; background: #ffeb3b; color: #333; padding: 15px; width: 140px; font-size: 0.8rem; font-weight: bold; transform: rotate(5deg); box-shadow: 5px 5px 10px rgba(0,0,0,0.2); text-align: center; border-bottom-right-radius: 30px 5px; }
.ui-footer { background: #0072bc; height: 80px; border-top: 6px solid #005a96; display: flex; justify-content: center; align-items: flex-end; padding-bottom: 10px; }
